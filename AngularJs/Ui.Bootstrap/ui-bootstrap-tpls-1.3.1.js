                ...
                compile: function (tElem, tAttrs) {
                    ...
                    return function link(scope, element, attrs, tooltipCtrl) {
                        ...
                        if (attrs.data) {
                            ...
                            var attrData = attrs.data.split('.');
                            while (parent != null) {

                                var result = parent[attrData[0]];
                                if(angular.isDefined(result))
                                for (var i = 1; i < attrData.length; i++) {

                                    if (angular.isDefined(result[attrData[1]]))
                                        result = result[attrData[1]];
                                }
                                if (angular.isDefined(result)) {
                                    ttScope.data = result;
                                    break;
                ...
                if (src) {
                    ...
                    $templateRequest(src, true).then(function (response) {
                        ...
                        while (parent != null) {
                            ...
                            if (angular.isDefined(parent['data'])) {
                                currentScope.data = parent['data'];
                                break;
                            }
                            parent = parent.$parent;
                        }
...
.directive('uibTooltipPopup', function () {
    return {
        replace: true,
        scope: { content: '@', placement: '@', popupClass: '@', animation: '&', isOpen: '&', data: '=' },
